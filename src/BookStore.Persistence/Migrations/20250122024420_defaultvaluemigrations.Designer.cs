...
namespace BookStore.Persistence.Migrations
{
    ...
    [Migration("20250122024420_defaultvaluemigrations")]
    partial class defaultvaluemigrations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStore.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("OperationNumbre")
                        .IsRequired()
                        .HasMaxLength(10)
            ...
            modelBuilder.Entity("BookStore.Persistence.BookStoreUserIdentity", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BookStore.Persistence.BookStoreUserIdentity", null)
                        .WithMany()
